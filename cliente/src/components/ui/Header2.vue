...
<template>
  <div class="row py-4 g-0 text-white" id="header">
    <div v-if="carga == 'Buscar'" class="col-12 d-flex gap-2 align-items-center">
      <form class="w-100">
    ...
    <div v-else class="d-flex align-items-center">
      <button @click="irAtras" type="submit" class="btn mx-3">
        <svg
          width="32"
          height="32"
          viewBox="0 0 32 32"
...
#header {
  ...
  border-bottom: solid 1px #ca40d6;
}
</style>
