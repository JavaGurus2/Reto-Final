...
@section('title', 'Actores/Actrices')
                ...
                <div class="card my-4 shadow-lg w-90 px-5">
                    <div class="card-header p-0 position-relative mx-3 z-index-2" style="margin-top: -1.5rem;">
                        <div
                            ...
                            <h6 class="text-white text-capitalize ps-3">Tabla de actores/actrices</h6>

                                <a href="{{ route('actores.create') }}" class="btn btn-success btn-md bg-gradient mb-3 mx-3">
                                    <i class="fa-solid fa-plus"></i><span class="mx-3">Añadir actor/actriz</span>
                                </a>
                                ...
                                <tbody>
                                    @forelse($actores as $actore)
                                        <tr>
                                            ...
                                            <td class="p-1">
                                                <a href="{{ route('actores.show', $actore) }}"
                                                    class="btn btn-primary btn-md">
                                                    <i class="fa-solid fa-eye"></i>
                                                </a>
                                                <button type="button" class="btn btn-danger btn-md" data-bs-toggle="modal"
                                                    data-bs-target="#confirmDeleteModal_{{ $actore->id }}"
                                                    data-product-id="{{ $actore->id }}">
                                                    <i class="fa-solid fa-trash"></i>
                                                </button>
                                                <!-- VENTANA MODAL -->
                                                <div class="modal fade" id="confirmDeleteModal_{{ $actore->id }}"
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="confirmDeleteModalLabel">
                                                                    Confirmar Borrado {{ $actore->id }}</h5>
                                                                <button type="button" class="btn-close"
                                                                    data-bs-dismiss="modal" aria-label="Cerrar"></button>
                                                            </div>
                                                            <div class="modal-body">
                                                                <p>¿Estás seguro de que deseas borrar este actor/actriz?</p>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary"
                                                                    data-bs-dismiss="modal">Cancelar</button>
                                                                <form method="post"
                                                                    action="{{ route('actores.destroy', $actore) }}">
                                                                    @csrf
                                                                    @method('DELETE')
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="7" class="text-center">No hay actores/actrices</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
